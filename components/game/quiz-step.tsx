...
export function QuizStep({ onBack }: QuizStepProps) {
        ...
        <div className="mt-6">
          ...
          >
            ...
            <div className="text-[13px] leading-relaxed max-w-[400px] mx-auto" style={{ color: "var(--text-quiz-option)" }}>
              {pass
                ? `You scored ${score}/${QUIZ.length}. Solid understanding of batch size, flow, and pull systems.`
